...
print("Model loaded")
model_id = "/home/2/uh02312/lyu/MT/output/llama3-sft-lora-NLLB_COMET_10k-cometkiwi-da-xl-lion-run2/checkpoint-27/merge"
...
tokenizer=AutoTokenizer.from_pretrained(model_id, use_fast=True, cache_dir="/home/2/uh02312/lyu/checkpoints")
