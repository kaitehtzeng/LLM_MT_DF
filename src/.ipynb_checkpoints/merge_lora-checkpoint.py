...
peft_name = "lyu/MT/output/llama3-sft-lora-16-NLLB-10k-run2/checkpoint-132"   #学習済みadapter_config.jsonのパス指定
output_dir = "lyu/MT/output/llama3-sft-lora-16-NLLB-10k-run2/checkpoint-132/merge"  #マージモデルの出力先
