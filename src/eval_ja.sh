...
CUDA_VISIBLE_DEVICES=$cuda_devices comet-score -s $src_file -t $hypo_file -r $tgt_file  --quiet --only_system --model_storage_path lyu/cache --model Unbabel/XCOMET-XXL --batch_size 8 >> $output_prefix/score.log
